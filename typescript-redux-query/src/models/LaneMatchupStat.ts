...
export function LaneMatchupStatFromJSON(json: any): LaneMatchupStat {
    return {
        'diff': json['diff'],
...
export function LaneMatchupStatToJSON(value?: LaneMatchupStat): any {
    if (value === undefined) {
        return undefined;
    }
    return {
