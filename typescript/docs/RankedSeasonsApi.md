...
|------------- | ------------- | -------------|
|[**listRankedSeasons**](#listrankedseasons) | **GET** /v1/assets/ranked-seasons | List Ranked Seasons|

# **listRankedSeasons**
> Array<RankedSeason> listRankedSeasons()
...
const apiInstance = new RankedSeasonsApi(configuration);
...
const { status, data } = await apiInstance.listRankedSeasons(
    language,
    clientVersion
);
```
