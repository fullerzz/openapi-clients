...
class TestLaneStatCurve(unittest.TestCase):
    """LaneStatCurve unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaneStatCurve:
        """Test LaneStatCurve
