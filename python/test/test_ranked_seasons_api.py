...
class TestRankedSeasonsApi(unittest.TestCase):
    """RankedSeasonsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RankedSeasonsApi()

    def tearDown(self) -> None:
        pass

    def test_list_ranked_seasons(self) -> None:
        """Test case for list_ranked_seasons
