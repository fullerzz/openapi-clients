...
class TestLaneMatchupStat(unittest.TestCase):
    """LaneMatchupStat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaneMatchupStat:
