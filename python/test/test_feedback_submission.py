...
class TestFeedbackSubmission(unittest.TestCase):
    """FeedbackSubmission unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedbackSubmission:
        ...
        if include_optional:
            return FeedbackSubmission(
                ...
                page_url = '',
                selector = '',
                source = deadlock_api_client.models.source_location.SourceLocation(
                    chain = [
                        ''
                        ], 
                    column = 56, 
                    ...
                    line = 56, ),
                targets = [
                    deadlock_api_client.models.feedback_target.FeedbackTarget(
                        element_text = '', 
                        selector = '', 
                        source = null, )
                    ],
                viewport = deadlock_api_client.models.viewport.Viewport(
    ...
    def testFeedbackSubmission(self):
        """Test FeedbackSubmission"""
