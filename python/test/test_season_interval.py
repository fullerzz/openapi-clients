...
class TestSeasonInterval(unittest.TestCase):
    """SeasonInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonInterval:
        """Test SeasonInterval
