...
class Viewport(BaseModel):
    ...
    Viewport
    """ # noqa: E501
    device_pixel_ratio: Union[StrictFloat, StrictInt]
    height: StrictInt
    width: StrictInt
    __properties: ClassVar[List[str]] = ["device_pixel_ratio", "height", "width"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device_pixel_ratio": obj.get("device_pixel_ratio"),
